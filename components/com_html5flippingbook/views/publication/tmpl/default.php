...
<style>
	...
	<div  style="float:left; padding: 30px 50px 20px 0px;">
			<span style="cursor:pointer;" onclick="location.href='<?php echo $item->rawPublicationLink; ?>#page/' + 1;"><?php echo $item->c_title; ?></span>	
							<ol>
							<li style="cursor:pointer;"><span class="labcolor" onclick="location.href='<?php echo $item->rawPublicationLink; ?>#page/' + 2;"><a>Coconut</a></span></li>
							<li style="cursor:pointer;"><span onclick="location.href='<?php echo $item->rawPublicationLink; ?>#page/' + 4;">Wood</span></li>
							<li style="cursor:pointer;"><span onclick="location.href='<?php echo $item->rawPublicationLink; ?>#page/' + 6;">Horn</span></li>
							<li style="cursor:pointer;"><span onclick="location.href='<?php echo $item->rawPublicationLink; ?>#page/' + 8;">Corozo</span></li>							
							</ol>
            ...
            <div class="container" id="zoom-viewport">
                <div class="flipbook">
                    <div ignore="1" class="fb_topBar <?php echo $detectMobile->isTablet() ? 'tablet-bar' : '';?>">
                        ...
                        <div class="tb_social">
                            <?php
							if ( !empty($item->contents_page) ) echo '<i class="tbicon table-contents" title="'.JText::_('COM_HTML5FLIPPINGBOOK_FE_TOOLBAR_CONTENTS').'" rel="'.$item->contents_page.'"></i>';
